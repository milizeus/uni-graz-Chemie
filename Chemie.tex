...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	\documentclass[
		...
		%%%% === Optionen für den Satzspiegel ===
			...
			DIV15,				% Seitengrösse (siehe Koma Skript Dokumentation !)
	%		DIV11,				% Seitengrösse (siehe Koma Skript Dokumentation !)
			%DIVcalc,				% automatische Berechnung einer guten Zeilenlänge
	...
	%		1.1headlines,			% Zeilenanzahl der Kopfzeilen
			...
			pagesize,				% Schreibt die Papiergrösse in die Datei. Wichtig für Konvertierungen
	   %footskip=0pt,    % distance separation between baseline of last line of text and baseline of footer	
		%%%% === Layout ===
			oneside,				% einseitiges Layout
			%twoside,				% Seitenränder für zweiseitiges Layout
		...
		%%%% === Verzeichnisse (TOC, LOF, LOT, BIB) ===
			...
			tocindent,				% eingerückte Gliederung
		...
		%%%% === Matheformeln ===
			...
			fleqn,				% Formeln werden linksbündig angezeigt
	...
	% Encoding der Dateien (sonst funktionieren Umlaute nicht)
			% Für Linux							-> utf8
			% Für MAC-OS							-> applemac
			% Für Windows, alte Linux Distributionen		-> latin1
